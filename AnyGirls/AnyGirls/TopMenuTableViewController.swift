...
class TopMenuTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let selfViewBounds = self.view.bounds
        let headerView =  UIView(frame: CGRectMake(selfViewBounds.origin.x, selfViewBounds.origin.y, selfViewBounds.size.width, 160))
